...
# contratos()
# main()
print("Probando si llegue al final, sin pasar por algunas de las funciones")

def descarga():
    print("Se selecciono descargas")
    contratos()
    main()

def parameterError():
	print("Error en el parametro") 
