...
#####################################AQUI COMIENZA LA CLASE DEL FRAMEWORK#########################################
...
###############************PARTE DE LA CLASE PARA EJECUTAR ORDENES Y REGISTRAR OPERACIONES************################
...
def main(): ###############************METODO PARA INSTANCIAR LA CLASE************################
    time.sleep(3)
    global finalList
    global myList
    global app
...
def main1():###############************METODO PARA INSTANCIAR LA CLASE************################
    time.sleep(3)
    app = TestApp()
    app.nextorderId = 0
    app.connect("127.0.0.1", 7497, 0)
